...
Let’s find daily mean temperature by station and day. Use `groupby` and `agg` to calculate the mean and create a new dataset `met_daily`.
...
If you like ggplot2, `plotnine` uses the same “add layers with +” workflow:
