...
|-----|--------------|-----------------|---------|
| **Week 1** | January 5 [(lecture)](slides/01-introduction/JSC370-slides-01.html) <br> January 7 (no in-person lab) | Introduction to Data Science tools: Python, Quarto, VS Code | **Lab 1** |
